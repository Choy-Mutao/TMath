...
namespace tmath.earcut
{
    public static class Earcut
    {
        public static List<int> Tessellate(IList<double> data, IList<int> holeIndices, int dim = 2)
        {
        ...
        static Node CureLocalIntersections(Node start, IList<int> triangles, int dim)
        {
            ...
            do
            {
                ...
                if (!Equals(a, b) && Intersects(a, p, p.next, b) && LocallyInside(a, b) && LocallyInside(b, a))
                {
                    ...
                    triangles.Add(a.i / dim | 0);
                    triangles.Add(p.i / dim | 0);
                    triangles.Add(b.i / dim | 0);
        ...
        public static double Deviation(IList<double> data, IList<int> holeIndices, IList<int> triangles, int dim = 2)
        {
            var hasHoles = holeIndices.Count > 0;
